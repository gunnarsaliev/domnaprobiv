...
function ScrollZoomController({ scrollWheelZoom }: { scrollWheelZoom?: boolean }): null {
  const map = useMap()

  useEffect(() => {
    if (scrollWheelZoom !== undefined) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <ScrollZoomController scrollWheelZoom={scrollWheelZoom} />
